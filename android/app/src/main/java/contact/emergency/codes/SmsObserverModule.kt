    ...
    fun startObserving(numbers: ReadableArray, promise: Promise) {
        try {
            ...
            smsReceiver = object : BroadcastReceiver() {
                override fun onReceive(context: Context?, intent: Intent?) {
                    ...
                    if (
                        ...
                        intent?.action != "contact.emergency.codes.PRIVATE_SMS_DELIVER"
                    ) return
            ...
            val filter = IntentFilter(Telephony.Sms.Intents.SMS_RECEIVED_ACTION).apply {
                addAction("contact.emergency.codes.PRIVATE_SMS_DELIVER")
            ...
            mockSmsReceiver = object : BroadcastReceiver() {
                override fun onReceive(context: Context?, intent: Intent?) {
                    if (intent?.action != "contact.emergency.codes.MOCK_OUTGOING_SMS") return
            ...
            val mockFilter = IntentFilter("contact.emergency.codes.MOCK_OUTGOING_SMS")
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
