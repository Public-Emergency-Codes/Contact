...
class EmergencySwitchInCallService : InCallService() {
    ...
    companion object {
        const val ACTION_ANSWER = "contact.emergency.codes.ACTION_ANSWER"
        const val ACTION_END = "contact.emergency.codes.ACTION_END"
        const val ACTION_TOGGLE_MUTE = "contact.emergency.codes.ACTION_TOGGLE_MUTE"
        const val ACTION_TOGGLE_SPEAKER = "contact.emergency.codes.ACTION_TOGGLE_SPEAKER"
