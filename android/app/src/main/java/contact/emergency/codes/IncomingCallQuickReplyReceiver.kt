...
class IncomingCallQuickReplyReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_SEND_QUICK_REPLY = "contact.emergency.codes.ACTION_SEND_QUICK_REPLY"
        const val ACTION_QUICK_REPLY_SENT = "contact.emergency.codes.ACTION_QUICK_REPLY_SENT"
